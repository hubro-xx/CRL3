...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    UserManage.Instance.Login(user,"user",false);//实现Form验证登录,并设定票据
        ...
        <tr><td>数据库</td><td>基本查询</td><td>自动创建表</td><td>with(nolock)查询</td><td>批量插入</td><td>存储过程</td><td>动态编译存储过程</td><td>自带业务封装</td><td>备注</td></tr>
        <tr><th>MSSQL</th><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>支持</td><td>&nbsp;</td></tr>
        <tr><th>MySQL</th><td>支持</td><td>支持</td><td class="notSupported">不支持</td><td class="notSupported">不支持</td><td>支持</td><td class="notSupported">不支持</td><td>支持</td><td>&nbsp;</td></tr>
        <tr><th>ORACLE</th><td>支持</td><td>支持(需高级权限)</td><td class="notSupported">不支持</td><td class="notSupported">不支持</td><td>支持</td><td class="notSupported">不支持</td><td>支持</td><td>&nbsp;</td></tr>
        </table>
